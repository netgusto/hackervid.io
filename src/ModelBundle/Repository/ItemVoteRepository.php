...
class ItemVoteRepository extends EntityRepository implements ServiceRepositoryInterface, ConvenientRepositoryInterface {
    ...
    public function create(ItemVote &$vote) : array {
